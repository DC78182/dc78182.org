                                ...
                                <div class="card-body pt-0">
                                    <div class="row">
                                        <div class="col-7">
                                            ...
                                            <p class="text-muted text-sm"><b>About: </b> Очень хорошая книга с примерами
                        ...
                        <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch">
                            <div class="card bg-light">
                                ...
                                <div class="card-body pt-0">
                                    <div class="row">
                                        <div class="col-7">
                                            <h2 class="lead"><b>Mastering Kali Linux for Web Penetration Testing</b>
                                            </h2>
                                            <p class="text-muted text-sm"><b>About: </b> Тоже достойное издание, здесь
                        ...
                        <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch">
                            <div class="card bg-light">
                                ...
                                <div class="card-body pt-0">
                                    <div class="row">
                                        <div class="col-7">
                                            <h2 class="lead"><b>XSS Attacks: Cross Site Scripting Exploits and
                                                    Defense</b></h2>
                                            <p class="text-muted text-sm"><b>About: </b> Книга полностью посвящена XSS.
                        ...
                        <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch">
                            <div class="card bg-light">
                                ...
                                <div class="card-body pt-0">
                                    <div class="row">
                                        <div class="col-7">
                                            <h2 class="lead"><b>The Tangled Web: A Guide to Securing Modern Web
                                                    Applications</b></h2>
                                            <p class="text-muted text-sm"><b>About: </b> Книга описывает безопасность
                                                клиентской части веб-приложений, начиная с самых основ: что такое URL,
                                                HTTP, Same Origin Policy и так далее — и заканчивая тонкостями
                                                реализации протоколов в популярных браузерах. Примечательна тем, что в
                                                ней приводится множество примеров того, как вещи, незначительные на
                                                первый взгляд, могут приводить к серьёзным уязвимостям. Книга вышла 9
                                                лет назад, и многие примеры уже не встретить в реальном мире: вроде
                        ...
                        <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch">
                            <div class="card bg-light">
                                ...
                                <div class="card-body pt-0">
                                    <div class="row">
                                        <div class="col-7">
                                            <h2 class="lead"><b>The Web Application Hacker's Handbook: Discovering and
                                                    Exploiting Security Flaws</b></h2>
                                            <p class="text-muted text-sm"><b>About: </b> Книга описывает
                                                структурированный подход к тестированию веб-приложений и то, как
                                                работают типовые уязвимости, которые в них встречаются. Полезно
                                ...
                                <div class="card-body pt-0">
                                    <div class="row">
                                        <div class="col-7">
                                            ...
                                            <p class="text-muted text-sm"><b>About: </b> В книге описано, как
                                ...
                                <div class="card-body pt-0">
                                    <div class="row">
                                        <div class="col-7">
                                            ...
                                            <p class="text-muted text-sm"><b>About: </b> Книга немного устарела, но тем
                                                не менее неплохо описывает, как работает Metasploit Framework. Подойдёт
                                ...
                                <div class="card-body pt-0">
                                    <div class="row">
                                        <div class="col-7">
                                            ...
                                            <p class="text-muted text-sm"><b>About: </b> В этой книге достаточно полно
                        ...
                        <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch">
                            <div class="card bg-light">
                                ...
                                <div class="card-body pt-0">
                                    <div class="row">
                                        <div class="col-7">
                                            <h2 class="lead"><b>The Hacker Playbook 3: Practical Guide To Penetration
                                                    Testing</b></h2>
                                ...
                                <div class="card-body pt-0">
                                    <div class="row">
                                        <div class="col-7">
                                            ...
                                            <p class="text-muted text-sm"><b>About: </b> Автор не учит применять
                                                известные эксплойты, а объясняет их работу и внутреннюю сущность.
                                                Сначала читатель знакомится с основами программирования на C, ассемблере
                                                и языке командной оболочки, учится исследовать регистры процессора.
                                                Затем приступает к хакингу — перезаписывает память, переполняя буфер,
                                                получает доступ к удалённому серверу, скрывая своё присутствие, и
                                                перехватывает соединения TCP. Изучив эти методы, можно взламывать
                                                зашифрованный трафик беспроводных сетей, успешно преодолевать системы
                                                защиты и обнаружения вторжений. Книга даёт полное представление о
                                                программировании, машинной архитектуре, сетевых соединениях и хакерских
                                                приёмах. С этими знаниями ваши возможности ограничены только
                                                воображением. Материалы для работы с этим изданием представлены в виде
                                ...
                                <div class="card-body pt-0">
                                    <div class="row">
                                        <div class="col-7">
                                            ...
                                            <p class="text-muted text-sm"><b>About: </b> Книга пригодится тем, кто
                                                планирует изучать анализ вредоносных программ. Но у неё есть недостаток
                                                — материал излагается поверхностно. Довольно подробно описывается софт,
                        ...
                        <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch">
                            <div class="card bg-light">
                                ...
                                <div class="card-body pt-0">
                                    <div class="row">
                                        <div class="col-7">
                                            <h2 class="lead"><b>Использование Docker</b></h2>
                                            <p class="text-muted text-sm"><b>About: </b> Сборник сценариев использования
                                                docker-контейнеров — от первых шагов до оркестрации и обеспечения
                                ...
                                <div class="card-body pt-0">
                                    <div class="row">
                                        <div class="col-7">
                                            ...
                                            <p class="text-muted text-sm"><b>About: </b> Если хотите понять, как
                        ...
                        <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch">
                            <div class="card bg-light">
                                ...
                                <div class="card-body pt-0">
                                    <div class="row">
                                        <div class="col-7">
                                            <h2 class="lead"><b>Безопасный DevOps. Эффективная эксплуатация систем</b>
                                            </h2>
                                            <p class="text-muted text-sm"><b>About: </b> Книга основана на уникальном
                                                опыте автора и предлагает важнейшие стратегические решения, которые
                                                помогут защитить веб-приложения от атак и предотвратить попытки
                                                вторжения. Вы поймёте, как обеспечить надёжность при автоматизированном
                                                тестировании, непрерывной поставке и ключевых DevOps-процессах. А ещё
                        ...
                        <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch">
                            <div class="card bg-light">
                                ...
                                <div class="card-body pt-0">
                                    <div class="row">
                                        <div class="col-7">
                                            <h2 class="lead"><b>Agile Application Security: Enabling Security in a
                                                    Continuous Delivery Pipeline</b></h2>
                                            <p class="text-muted text-sm"><b>About: </b> С помощью этого практического
                                ...
                                <div class="card-body pt-0">
                                    <div class="row">
                                        <div class="col-7">
                                            ...
                                            <p class="text-muted text-sm"><b>About: </b> Книга описывает построение
                                                сетей на базе коммутаторов D-Link. Будет особенно полезна тем, кто
                                ...
                                <div class="card-body pt-0">
                                    <div class="row">
                                        <div class="col-7">
                                            ...
                                            <p class="text-muted text-sm"><b>About: </b> В этой книге описываются
                                                аппаратные и программные средства противодействия атакам, а также
                                                приводятся рекомендации, как грамотно применять их. Теория изложена
                                                просто и наглядно, закрепляется на реальных примерах — и это позволяет
                                                даже неподготовленному читателю организовать надёжную защиту своей
                                                локальной сети или её отдельного узла. В отличие от многих подобных
                                                изданий, здесь описывается полная последовательность действий, которые
                                                надо предпринять в нестандартной ситуации. Книга рассчитана на системных
                ...
                <div class="card-body">
                    <div class="row d-flex align-items-stretch">
                        <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch">
                            <div class="card bg-light">
                                <div class="card-header text-muted border-bottom-0">
                                    Алекс Замм, Шива Парасрам, Шакил Али, Джерард Йохансен, Теди Хериянто, Дамиан Буду,
                                    Ли Аллен
                                </div>
                                <div class="card-body pt-0">
                                    <div class="row">
                                        <div class="col-7">
                                            <h2 class="lead"><b>Kali Linux. Тестирование на проникновение и
                                                    безопасность</b></h2>
                                            <p class="text-muted text-sm"><b>About: </b> Книга описывает развёртывание
                                ...
                                <div class="card-body pt-0">
                                    <div class="row">
                                        <div class="col-7">
                                            ...
                                            <p class="text-muted text-sm"><b>About: </b> Эта книга — своеобразное
                                ...
                                <div class="card-body pt-0">
                                    <div class="row">
                                        <div class="col-7">
                                            ...
                                            <p class="text-muted text-sm"><b>About: </b> Книга поэтапно описывает, как
                        ...
                        <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch">
                            <div class="card bg-light">
                                ...
                                <div class="card-body pt-0">
                                    <div class="row">
                                        <div class="col-7">
                                            <h2 class="lead"><b>Прикладная криптография. Протоколы, алгоритмы и исходный
                                                    код на языке C</b></h2>
                                            <p class="text-muted text-sm"><b>About: </b> В книге подробно и на практике
                                                рассматриваются вопросы криптографической защиты информации. Это
